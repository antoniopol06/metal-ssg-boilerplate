...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    exports.main = $main;
    if (goog.DEBUG) {
      $main.soyTemplateName = 'Topbar.main';
    }
    ...
    function $logo(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_void('span', null, null, 'class', 'icon icon-16-heart');
    ...
    function $menu(opt_data, opt_ignored, opt_ijData) {
      ...
      var itemList61 = opt_data.site.index.children;
      var itemListLen61 = itemList61.length;
      for (var itemIndex61 = 0; itemIndex61 < itemListLen61; itemIndex61++) {
        var itemData61 = itemList61[itemIndex61];
        ie_open('li', null, null, 'class', 'topbar-item');
        ie_open('a', null, null, 'class', 'topbar-link ' + (itemData61.active ? 'topbar-link-selected' : ''), 'href', itemData61.url);
        var dyn7 = itemData61.title;
    ...
    exports.main.params = ["site"];
    exports.main.types = { "site": "any" };
    exports.logo.params = [];
    exports.logo.types = {};
...
(function () {
    ...
    goog.loadModule(function (exports) {
        ...
        function $render(opt_data, opt_ignored, opt_ijData) {
            ...
            ie_close('meta');
            ie_open('meta', null, null, 'name', 'format-detection', 'content', 'telephone=no');
            ie_close('meta');
            ...
            ie_close('link');
            ie_open('link', null, null, 'rel', 'stylesheet', 'href', '/styles/main.css');
            ie_close('link');
            ie_open('link', null, null, 'rel', 'stylesheet', 'href', '/fonts/galano/galano.css');
            ie_close('link');
            ie_open('link', null, null, 'rel', 'stylesheet', 'href', '/fonts/icon-12/icon-12.css');
            ie_close('link');
            ie_open('link', null, null, 'rel', 'stylesheet', 'href', '/fonts/icon-16/icon-16.css');
            ie_close('link');
            ie_close('head');
            ie_open('body');
            ...
            ie_close('div');
            ie_void('script', null, null, 'src', '/js/bundle.js');
            if (opt_data.scripts) {
                var scriptList15 = opt_data.scripts;
                var scriptListLen15 = scriptList15.length;
                for (var scriptIndex15 = 0; scriptIndex15 < scriptListLen15; scriptIndex15++) {
                    var scriptData15 = scriptList15[scriptIndex15];
                    ie_void('script', null, null, 'src', scriptData15);
                }
            }
            ie_open('script');
            itext('metal.Component.render(metal[\'');
            var dyn2 = opt_data.page.componentName;
            if (typeof dyn2 == 'function') dyn2();else if (dyn2 != null) itext(dyn2);
            itext('\'], {element: \'#pageComponent\', site: JSON.parse(');
        ...
        exports.render.params = ["content", "page", "scripts", "serialized"];
        exports.render.types = { "content": "any", "page": "any", "scripts": "any", "serialized": "any" };
        templates = exports;
        return exports;
    });
    ...
    Soy.register(base, templates);
    this['metalNamed']['base'] = this['metalNamed']['base'] || {};
    this['metalNamed']['base']['base'] = base;
    this['metalNamed']['base']['templates'] = templates;
    this['metal']['base'] = templates;
    /* jshint ignore:end */
}).call(this);
'use strict';
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param25 = function param25() {
        $templateAlias2({ items: opt_data.site.index.children[0].children }, null, opt_ijData);
        $guide(opt_data, null, opt_ijData);
      };
      $templateAlias1(soy.$$assignDefaults({ elementClasses: 'docs', content: param25 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
    ...
    function $guide(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('div', null, null, 'class', 'docs-nav affix-top');
      ie_open('div', null, null, 'id', 'reading-container');
      ie_open('div', null, null, 'class', 'reading-progress');
      ie_open('ul');
      ie_open('li');
      ie_open('a', null, null, 'href', '#install-dependencies', 'class', '');
      ...
      ie_void('circle', null, null, 'fill', 'none', 'stroke-width', '2', 'cx', '18', 'cy', '18', 'r', '16', 'stroke-dasharray', '100 100', 'transform', 'rotate(-90 18 18)', 'stroke-dashoffset', '84.82758620689656');
      ie_close('svg');
      ie_close('a');
      ie_close('li');
      ie_open('li');
      ie_open('a', null, null, 'href', '#running-locally', 'class', '');
      ie_open('span', null, null, 'class', 'reading-title');
      ...
      ie_close('span');
      ie_open('svg', null, null, 'x', '0px', 'y', '0px', 'width', '36px', 'height', '36px', 'viewBox', '0 0 36 36');
      ie_void('circle', null, null, 'fill', 'none', 'stroke-width', '2', 'cx', '18', 'cy', '18', 'r', '16', 'stroke-dasharray', '100 100', 'transform', 'rotate(-90 18 18)', 'stroke-dashoffset', '87.35632183908046');
      ie_close('svg');
      ie_close('a');
      ie_close('li');
      ie_open('li');
      ie_open('a', null, null, 'href', '#deploying-to-the-cloud', 'class', '');
      ie_open('span', null, null, 'class', 'reading-title');
      ...
      ie_close('span');
      ie_open('svg', null, null, 'x', '0px', 'y', '0px', 'width', '36px', 'height', '36px', 'viewBox', '0 0 36 36');
      ie_void('circle', null, null, 'fill', 'none', 'stroke-width', '2', 'cx', '18', 'cy', '18', 'r', '16', 'stroke-dasharray', '100 100', 'transform', 'rotate(-90 18 18)', 'stroke-dashoffset', '99.81378026070763');
      ie_close('svg');
      ie_close('a');
      ie_close('li');
      ie_open('li');
      ie_open('a', null, null, 'href', '#key-capabilities', 'class', '');
      ie_open('span', null, null, 'class', 'reading-title');
      ...
      ie_close('span');
      ie_open('svg', null, null, 'x', '0px', 'y', '0px', 'width', '36px', 'height', '36px', 'viewBox', '0 0 36 36');
      ie_void('circle', null, null, 'fill', 'none', 'stroke-width', '2', 'cx', '18', 'cy', '18', 'r', '16', 'stroke-dasharray', '100 100', 'transform', 'rotate(-90 18 18)', 'stroke-dashoffset', '100');
      ie_close('svg');
      ie_close('a');
      ie_close('li');
      ie_open('li');
      ie_open('a', null, null, 'href', '#initializing-auth');
      ie_open('span', null, null, 'class', 'reading-title');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    var $templateAlias1 = Soy.getTemplate('Topbar.incrementaldom', 'main');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias1(soy.$$assignDefaults({ content: param66 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
    ...
    function $header(opt_data, opt_ignored, opt_ijData) {
      ...
      var dyn8 = opt_data.site.index.description;
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace pageDocsBuild.
     * @public
     */

    goog.module('pageDocsBuild.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias1(soy.$$assignDefaults({ content: param90 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'pageDocsBuild.render';
    }
  ...
  var pageDocsBuild = function (_Component) {
    babelHelpers.inherits(pageDocsBuild, _Component);

    function pageDocsBuild() {
      babelHelpers.classCallCheck(this, pageDocsBuild);
      return babelHelpers.possibleConstructorReturn(this, (pageDocsBuild.__proto__ || Object.getPrototypeOf(pageDocsBuild)).apply(this, arguments));
    }

    return pageDocsBuild;
  }(Component);

  Soy.register(pageDocsBuild, templates);
  this['metalNamed']['build'] = this['metalNamed']['build'] || {};
  this['metalNamed']['build']['pageDocsBuild'] = pageDocsBuild;
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace pageDocsCreate.
     * @public
     */

    goog.module('pageDocsCreate.incrementaldom');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'pageDocsCreate.render';
    }
  ...
  var pageDocsCreate = function (_Component) {
    babelHelpers.inherits(pageDocsCreate, _Component);

    function pageDocsCreate() {
      babelHelpers.classCallCheck(this, pageDocsCreate);
      return babelHelpers.possibleConstructorReturn(this, (pageDocsCreate.__proto__ || Object.getPrototypeOf(pageDocsCreate)).apply(this, arguments));
    }

    return pageDocsCreate;
  }(Component);

  Soy.register(pageDocsCreate, templates);
  this['metalNamed']['create'] = this['metalNamed']['create'] || {};
  this['metalNamed']['create']['pageDocsCreate'] = pageDocsCreate;
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace pageDocsDeploy.
     * @public
     */

    goog.module('pageDocsDeploy.incrementaldom');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'pageDocsDeploy.render';
    }
  ...
  var pageDocsDeploy = function (_Component) {
    babelHelpers.inherits(pageDocsDeploy, _Component);

    function pageDocsDeploy() {
      babelHelpers.classCallCheck(this, pageDocsDeploy);
      return babelHelpers.possibleConstructorReturn(this, (pageDocsDeploy.__proto__ || Object.getPrototypeOf(pageDocsDeploy)).apply(this, arguments));
    }

    return pageDocsDeploy;
  }(Component);

  Soy.register(pageDocsDeploy, templates);
  this['metalNamed']['deploy'] = this['metalNamed']['deploy'] || {};
  this['metalNamed']['deploy']['pageDocsDeploy'] = pageDocsDeploy;
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace pageDocsDevelop.
     * @public
     */

    goog.module('pageDocsDevelop.incrementaldom');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'pageDocsDevelop.render';
    }
  ...
  var pageDocsDevelop = function (_Component) {
    babelHelpers.inherits(pageDocsDevelop, _Component);

    function pageDocsDevelop() {
      babelHelpers.classCallCheck(this, pageDocsDevelop);
      return babelHelpers.possibleConstructorReturn(this, (pageDocsDevelop.__proto__ || Object.getPrototypeOf(pageDocsDevelop)).apply(this, arguments));
    }

    return pageDocsDevelop;
  }(Component);

  Soy.register(pageDocsDevelop, templates);
  this['metalNamed']['develop'] = this['metalNamed']['develop'] || {};
  this['metalNamed']['develop']['pageDocsDevelop'] = pageDocsDevelop;
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias1(soy.$$assignDefaults({ elementClasses: 'docs', content: param111 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
    ...
    function $topics(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_close('div');
      ie_open('div', null, null, 'class', 'row');
      ie_open('form', null, null, 'class', 'docs-home-top-form', 'action', '/docs/search/', 'method', 'GET', 'enctype', 'multipart/form-data');
      ...
      for (var topicIndex125 = 0; topicIndex125 < topicListLen125; topicIndex125++) {
        ...
        ie_open('a', null, null, 'class', 'topic radial-out', 'href', topicData125.url);
        ie_open('div', null, null, 'class', 'topic-icon');
        ie_void('span', null, null, 'class', 'icon-16-' + topicData125.icon);
        ie_close('div');
        ie_open('h3', null, null, 'class', 'topic-title');
        var dyn9 = topicData125.title;
...
(function () {
  ...
  this['metal']['pageDocsBuild'] = pageDocsBuild;
}).call(this);
'use strict';
...
(function () {
  ...
  this['metal']['pageDocsCreate'] = pageDocsCreate;
}).call(this);
'use strict';
...
(function () {
  ...
  this['metal']['pageDocsDeploy'] = pageDocsDeploy;
}).call(this);
'use strict';
...
(function () {
  ...
  this['metal']['pageDocsDevelop'] = pageDocsDevelop;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var $$temp;
      var localCurrentDepth__soy130 = ($$temp = opt_data.currentDepth) == null ? 0 : $$temp;
      if (opt_data.section.children) {
        ie_open('ul', null, null, 'class', ($$temp = opt_data.elementClasses) == null ? '' : $$temp);
        var pageList166 = opt_data.section.children;
        ...
        for (var pageIndex166 = 0; pageIndex166 < pageListLen166; pageIndex166++) {
          ...
          ie_open('li', null, null, 'class', (($$temp = opt_data.listItemClasses) == null ? '' : $$temp) + (pageData166.active ? ' active' : ''));
          if (pageData166.url) {
            ie_open('a', null, null, 'class', ($$temp = opt_data.linkClasses) == null ? '' : $$temp, 'href', pageData166.url);
            ie_open('span');
            var dyn10 = ($$temp = pageData166.title) == null ? 'Missing' : $$temp;
            if (typeof dyn10 == 'function') dyn10();else if (dyn10 != null) itext(dyn10);
            ie_close('span');
            ie_close('a');
          } else {
            ie_open('span', null, null, 'class', ($$temp = opt_data.linkClasses) == null ? '' : $$temp);
            var dyn11 = ($$temp = pageData166.title) == null ? 'Missing' : $$temp;
            if (typeof dyn11 == 'function') dyn11();else if (dyn11 != null) itext(dyn11);
            ie_close('span');
          }
          if (!opt_data.depth || localCurrentDepth__soy130 + 1 < opt_data.depth) {
            $render({ currentDepth: localCurrentDepth__soy130 + 1, currentURL: opt_data.currentURL, depth: opt_data.depth, elementClasses: opt_data.elementClasses, linkClasses: opt_data.linkClasses, listItemClasses: opt_data.listItemClasses, section: pageData166 }, null, opt_ijData);
          }
          ie_close('li');
        }
        ie_close('ul');
    ...
    exports.render.params = ["currentDepth", "currentURL", "depth", "elementClasses", "linkClasses", "listItemClasses", "section"];
    exports.render.types = { "currentDepth": "any", "currentURL": "any", "depth": "any", "elementClasses": "any", "linkClasses": "any", "listItemClasses": "any", "section": "any" };
    templates = exports;
    return exports;
  });
  ...
  this['metalNamed']['Navigation'] = this['metalNamed']['Navigation'] || {};
  this['metalNamed']['Navigation']['Navigation'] = Navigation;
  this['metalNamed']['Navigation']['templates'] = templates;
  this['metal']['Navigation'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	var Component = this['metal']['component'];
	var Soy = this['metal']['Soy'];
	var templates = this['metal']['Navigation'];
	...
	this['metal']['Navigation'] = Navigation;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('form', null, null, 'class', 'sidebar-search', 'action', '/docs/search/', 'method', 'GET', 'enctype', 'multipart/form-data');
      ie_open('div', null, null, 'class', 'form-group');
      ie_open('div', null, null, 'class', 'input-inner-addon input-inner-addon-right');
      ie_open('input', null, null, 'name', 'q', 'class', 'form-control', 'type', 'text', 'placeholder', 'Search Docs', 'autocomplete', 'off', 'required', '');
      ie_close('input');
      ie_void('span', null, null, 'class', 'input-inner-icon-helper icon-16-magnifier');
      ie_close('div');
      ie_close('div');
      ie_close('form');
      ie_close('li');
      var itemList181 = opt_data.items;
      ...
      for (var itemIndex181 = 0; itemIndex181 < itemListLen181; itemIndex181++) {
        ...
        ie_open('li', null, null, 'class', 'sidebar-item');
        ie_open('a', null, null, 'class', 'sidebar-link ' + (itemData181.active ? 'sidebar-link-selected' : ''), 'href', itemData181.url);
        ie_void('span', null, null, 'class', 'sidebar-icon icon-16-' + itemData181.icon);
        ie_open('span');
        var dyn12 = itemData181.title;
